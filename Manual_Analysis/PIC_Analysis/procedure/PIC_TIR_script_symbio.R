...
pic.output
write.table(pic.output,file="./output/PIC_Sym_output_its2&clade.csv",append=TRUE, sep=",", row.names=FALSE, col.names=FALSE)
...
print(output_row)
write.table(output_row, file="./output/PIC_Sym_output_its2&clade.csv", append=TRUE, sep=",", row.names=FALSE, col.names=FALSE)
